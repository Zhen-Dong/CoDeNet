...
from .._ext.dcn import dcn_deform_pool_cuda
...
class DeformRoIPoolingFunction(Function):
    ...
    def forward(ctx,
        ...
        dcn_deform_pool_cuda.deform_psroi_pooling_cuda_forward(
    ...
    def backward(ctx, grad_output):
        ...
        dcn_deform_pool_cuda.deform_psroi_pooling_cuda_backward(
